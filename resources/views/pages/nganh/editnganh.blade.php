        ...
        <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa ngành học</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">CHỈNH SỬA NGÀNH HỌC</h4>
        </div>
    </div>
    </br>
    <?php
    ...
    ?>
    @foreach ($editnganh as $key => $item)
        <form action="{{URL::to('/action_editnganh'.'/'.$item -> mahe)}}" method="POST">
            {{ csrf_field() }}
            <div class="form-group row">
                <label class="col-sm-6 col-md-2 col-form-label">Mã ngành</label>
                <div class="col-sm-6 col-md-10">
                    <input class="form-control" readonly value="{{$item -> manganh}}" type="text" name="manganh" placeholder="Mã ngành...">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-6 col-md-2 col-form-label">Tên ngành</label>
                <div class="col-sm-6 col-md-10">
                    <input class="form-control" value="{{$item -> tennganh}}" name="tennganh" placeholder="Tên ngành" type="text">
                </div>
            </div>
            <div class="form-group row">
