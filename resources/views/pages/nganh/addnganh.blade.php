        ...
        <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Thêm ngành học</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">THÊM NGÀNH HỌC</h4>
        </div>
    </div>
    </br>
    <?php
    ...
    ?>
    <form action="{{URL::to('/savenganh')}}" method="POST">
        {{ csrf_field() }}
        <div class="form-group row">
            <label class="col-sm-6 col-md-2 col-form-label">Mã ngành</label>
            <div class="col-sm-6 col-md-10">
                <input class="form-control" type="text" name="manganh" placeholder="Mã ngành...">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-6 col-md-2 col-form-label">Tên ngành</label>
            <div class="col-sm-6 col-md-10">
                <input class="form-control" name="tennganh" placeholder="Tên ngành..." type="text">
            </div>
        </div>
        <div class="form-group row">
